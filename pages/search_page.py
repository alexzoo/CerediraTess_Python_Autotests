...
class SearchPage(BasePage):
    ...
    def make_search(self, item_name: str) -> None:
        ...
        self.page.locator(self.search_results).wait_for()
    ...
    def sort_results(self, sort_type: str) -> None:
        ...
        self.page.locator(self.sort_dropdown).click()
        self.page.locator(self.sort_dropdown).get_by_text(sort_type).click()
        assert self.page.locator(self.sort_dropdown).get_by_text(sort_type).is_checked()
        self.page.wait_for_load_state()
